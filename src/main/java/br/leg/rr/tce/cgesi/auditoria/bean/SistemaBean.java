...
import br.leg.rr.tce.cgesi.auditoria.ejb.SistemaEjb;
import br.leg.rr.tce.cgesi.auditoria.entity.Auditoria;
import br.leg.rr.tce.cgesi.auditoria.entity.CriteriosSelecao;
import br.leg.rr.tce.cgesi.auditoria.entity.OrigemAuditoria;
import br.leg.rr.tce.cgesi.auditoria.entity.Servidor;
import br.leg.rr.tce.cgesi.auditoria.entity.StatusPortaria;
import br.leg.rr.tce.cgesi.auditoria.entity.TipoAuditor;
import br.leg.rr.tce.cgesi.auditoria.entity.TipoFiscalizacao;
import br.leg.rr.tce.cgesi.auditoria.entity.UnidadeFiscalizadora;
...
public class SistemaBean extends AbstractBean implements Serializable {
	...
	//modelo de lista padr�o por sistema
